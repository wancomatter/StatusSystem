...
# サンプルステータス
    # 移動速度
        function _sample:sample/viewer/set_color/normal with storage status_viewer:sample _.Speed
        data modify storage status_viewer:sample _.StatusViewer.Speed set from storage status_viewer:sample _.Out
    # 登れる段差上限
        function _sample:sample/viewer/set_color/has_demical with storage status_viewer:sample _.StepHeight
        data modify storage status_viewer:sample _.StatusViewer.StepHeight set from storage status_viewer:sample _.Out
    # ノックバック耐性
        function _sample:sample/viewer/set_color/normal with storage status_viewer:sample _.KnockbackResistance
        data modify storage status_viewer:sample _.StatusViewer.KnockbackResistance set from storage status_viewer:sample _.Out
    # 最大MP
        function _sample:sample/viewer/set_color/normal with storage status_viewer:sample _.MPMax
        data modify storage status_viewer:sample _.StatusViewer.MPMax set from storage status_viewer:sample _.Out
    # MP自然回復速度
        function _sample:sample/viewer/set_color/normal with storage status_viewer:sample _.MPRegenSpeed
        data modify storage status_viewer:sample _.StatusViewer.MPRegenSpeed set from storage status_viewer:sample _.Out
    # MP自然回復量
        function _sample:sample/viewer/set_color/normal with storage status_viewer:sample _.MPRegenAmount
