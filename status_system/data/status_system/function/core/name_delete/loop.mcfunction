...
# ストレージを複製
data modify storage status_system: Temporary3 set from storage status_system: Temporary2.Modifier[0]
...
execute unless score #Status.NameDelete.tmp StatusSystem matches 0 run data modify storage status_system: Temporary.Modifier append from storage status_system: Temporary2.Modifier[0]
...
# ストレージを削除
data remove storage status_system: Temporary2.Modifier[0]
